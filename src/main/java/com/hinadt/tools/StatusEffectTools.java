...
public class StatusEffectTools {
    ...
    public String catalogStatusEffects() {
        ...
        AusukaAiMod.LOGGER.debug("{} [tool:catalog_status_effects] count={} cost={}ms",
    ...
    public String searchStatusEffects(
        ...
        AusukaAiMod.LOGGER.debug("{} [tool:search_status_effects] params q='{}' limit={}",
        ...
        AusukaAiMod.LOGGER.debug("{} [tool:search_status_effects] q='{}' limit={} count={} cost={}ms preview=[{}]",
    ...
    public String listStatusEffects(@ToolParam(description = "Player name or UUID") String playerName) {
        AusukaAiMod.LOGGER.debug("{} [tool:list_status_effects] player='{}'", RequestContext.midTag(), playerName);
        long startNanos = System.nanoTime();
        ...
        AusukaAiMod.LOGGER.debug("{} [tool:list_status_effects] player='{}' count={} cost={}ms",
    ...
    public String applyStatusEffect(
        ...
        long startNanos = System.nanoTime();
        AusukaAiMod.LOGGER.debug("{} [tool:apply_status_effect] player='{}' effect='{}' seconds={} amp={} ambient={} particles={} icon={}",
        ...
        String out = ref.get();
        AusukaAiMod.LOGGER.debug("{} [tool:apply_status_effect] player='{}' resolved='{}' amp={} secs={} cost={}ms",
    ...
    public String clearStatusEffects(
        ...
        long startNanos = System.nanoTime();
        AusukaAiMod.LOGGER.debug("{} [tool:clear_status_effects] player='{}' mode='{}' effects='{}'",
        ...
        return MainThread.callSync(server, () -> {
            ...
            switch (m) {
                case "all" -> {
                    ...
                    AusukaAiMod.LOGGER.debug("{} [tool:clear_status_effects] mode=all player='{}' cleared={}",
                ...
                case "negative", "positive", "beneficial", "neutral" -> {
                    ...
                    AusukaAiMod.LOGGER.debug("{} [tool:clear_status_effects] mode={} player='{}' cleared={}",
                ...
                case "specific" -> {
                    ...
                    AusukaAiMod.LOGGER.debug("{} [tool:clear_status_effects] mode=specific player='{}' cleared={} details={}",
            ...
            AusukaAiMod.LOGGER.warn("{} [tool:clear_status_effects] bad mode='{}' cost={}ms",
