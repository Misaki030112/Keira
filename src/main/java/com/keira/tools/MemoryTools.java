...
public class MemoryTools {
    ...
    public String saveLocation(
        ...
        KeiraAiMod.LOGGER.debug("{} [tool:save_location] params player='{}' name='{}' desc='{}'",
        ...
        MainThread.runSync(server, () -> {
            try {
                ...
                KeiraAiMod.LOGGER.info("{} [tool:save_location] done name='{}' world='{}' pos=({},{},{}) cost={}ms",
    ...
    public String getSavedLocation(
        ...
        long startNanos = System.nanoTime();
        try {
            KeiraAiMod.LOGGER.debug("{} [tool:get_saved_location] params player='{}' name='{}'",
                    RequestContext.midTag(), playerName, locationName);
            com.keira.persistence.record.LocationRecord location = 
            ...
            KeiraAiMod.LOGGER.info("{} [tool:get_saved_location] hit name='{}' world='{}' cost={}ms",
                    RequestContext.midTag(), location.locationName(), location.world(), (System.nanoTime()-startNanos)/1_000_000L);
            return out;
                
        } catch (Exception e) {
            KeiraAiMod.LOGGER.error("Failed to get location memory", e);
    ...
    public String listSavedLocations(
        ...
        long startNanos = System.nanoTime();
        try {
            KeiraAiMod.LOGGER.debug("{} [tool:list_saved_locations] params player='{}'",
                    RequestContext.midTag(), playerName);
            java.util.List<com.keira.persistence.record.LocationRecord> locations = 
            ...
            KeiraAiMod.LOGGER.info("{} [tool:list_saved_locations] return size={} cost={}ms",
                    RequestContext.midTag(), locations.size(), (System.nanoTime()-startNanos)/1_000_000L);
            return result.toString();
            
        } catch (Exception e) {
            KeiraAiMod.LOGGER.error("Failed to list location memory", e);
    ...
    public String deleteSavedLocation(
        ...
        long startNanos = System.nanoTime();
        try {
            KeiraAiMod.LOGGER.debug("{} [tool:delete_saved_location] params player='{}' name='{}'",
                    RequestContext.midTag(), playerName, locationName);
            boolean deleted = AiRuntime.getConversationMemory().deleteLocation(playerName, locationName);
            
            if (deleted) {
                KeiraAiMod.LOGGER.info("{} [tool:delete_saved_location] deleted name='{}' cost={}ms",
    ...
    public String findLocation(
        ...
        long startNanos = System.nanoTime();
        try {
            KeiraAiMod.LOGGER.debug("{} [tool:find_location] params player='{}' name='{}'",
                    RequestContext.midTag(), playerName, locationName);
            ...
            KeiraAiMod.LOGGER.info("{} [tool:find_location] hit name='{}' world='{}' cost={}ms",
            ...
            KeiraAiMod.LOGGER.error("Failed to find location", e);
            JsonObject root = new JsonObject();
            root.addProperty("ok", false);
