...
public class AdminTools {
    ...
    public String kickPlayer(
        ...
        KeiraAiMod.LOGGER.debug("{} [tool:kick_player] admin='{}' target='{}' reason='{}'",
    ...
    public String banPlayer(
        ...
        KeiraAiMod.LOGGER.debug("{} [tool:ban_player] admin='{}' target='{}' reason='{}'",
                RequestContext.midTag(), adminName, targetPlayerName, reason);
        ...
        ServerPlayerEntity target = server.getPlayerManager().getPlayer(targetPlayerName);
        if (isPlayerAdmin(server, target)) return "❌ Cannot ban another admin.";
    ...
    public String freezePlayer(
        ...
        KeiraAiMod.LOGGER.debug("{} [tool:freeze_player] admin='{}' target='{}' freeze={}",
    ...
    public String forcePlayerTeleport(
        ...
        KeiraAiMod.LOGGER.debug("{} [tool:teleport_player_force] admin='{}' target='{}' xyz=({}, {}, {}) destPlayer='{}'",
    ...
    public String jailPlayer(
        ...
        KeiraAiMod.LOGGER.debug("{} [tool:jail_player] admin='{}' target='{}' jail={} reason='{}'",
    ...
    public static String getAdminWelcomeInfo(String playerName) {
        return String.format("🛡️ Admin %s, welcome to Keira. You have access to moderation tools like kick, ban, freeze, force teleport, and jail. Use responsibly.", playerName);
    }
