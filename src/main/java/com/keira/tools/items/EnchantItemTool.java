...
"""
    ...
    public EnchantResult enchantItem(
        ...
        KeiraAiMod.LOGGER.debug("{} [tool:enchant_item] args target='{}' slot='{}' allowUnsafe={} removeConflicts={} enchants={}",
        ...
        KeiraAiMod.LOGGER.debug("{} [tool:enchant_item] result code={} msg='{}'",
...
"""
    ...
    public String listInventory(
        ...
        KeiraAiMod.LOGGER.debug("{} [tool:list_inventory] args target='{}' filter='{}' limit={} offset={}",
        ...
        MainThread.runSync(server, () -> {
            KeiraAiMod.LOGGER.debug("{} [tool:list_inventory] collecting stacks for player='{}'",
            ...
            KeiraAiMod.LOGGER.debug("{} [tool:list_inventory] collected rows={} before filtering",
            ...
            KeiraAiMod.LOGGER.debug("{} [tool:list_inventory] after filtering size={} filter='{}'",
            ...
            ref.set(payload);
            KeiraAiMod.LOGGER.debug("{} [tool:list_inventory] return items={} bytes={} preview={}",
