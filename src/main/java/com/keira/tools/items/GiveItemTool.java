...
public class GiveItemTool {
    ...
    public GiveItemResult giveItem(
        ...
        KeiraAiMod.LOGGER.debug("{} [tool:give_item] params target='{}' item='{}' count={}",
        ...
        if (id == null) {
            ...
            KeiraAiMod.LOGGER.warn("{} [tool:give_item] result code={} msg='{}'",
        ...
        KeiraAiMod.LOGGER.info("{} [tool:give_item] done code={} given={} dropped={} cost={}ms",
